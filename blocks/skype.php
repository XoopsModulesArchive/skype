...
<a href='skype:".$skype_user."?call'><img src='".XOOPS_URL."/modules/skype/images/call.png' style='border: none;' alt='Call me!' />&nbsp;"._SKP_CALLME."</a>
<select name='formsk' onchange='window.location=this.options[selectedIndex].value'>
  ...
  <option value='http://www.skype.com/download/' target='_blank'>"._SKP_DOWNLOAD."</option>
</select>";
return $block;
}
?>